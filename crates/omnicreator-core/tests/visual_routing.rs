...
use omnicreator_core::{
    ...
    GeneratedImageStyleV1, LogicalUri, PluginJobWorkspace, PluginProcessOptions,
    RankedVisualCandidate, SceneIntentV1, SelectedVisualOutput, StateStore, StepStatus,
    StockDiscoveryStatusV1, VisualCandidate, VisualCandidatePreview, VisualCandidateScore,
    VisualMediaType, VisualPreviewKind, VisualRouteV1, VisualRoutingPolicyV1,
